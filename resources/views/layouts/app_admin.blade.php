    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li><a href="/"><i class="fa fa-home"></i> <span>To shop</span></a></li>
                <li><a href="{{route('blog.admin.index.index')}}"><i class="fa fa-user"></i> <span>Main
                            admin</span></a></li>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.categories.index')}}">Categories list</a></li>
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.products.index')}}">Products list</a></li>
                        <li><a href="{{route('blog.admin.products.create')}}">Add product</a></li>
                    </ul>
                </li>
                <li><a href="{{route('blog.admin.cache')}}"><i class="fa fa-database"></i> <span>Cashing</span></a></li>
                <li class="treeview">
                ...
                <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{route('blog.admin.users.index')}}">Users list</a></li>
                        <li><a href="{{route('blog.admin.users.create')}}">Add user</a></li>
                    </ul>
                </li>
                <li class="treeview">
...
<i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('/admin/currency/index')}}">Currencies list</a></li>
...
<i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{url('admin/filter/group-filter')}}">Filters groups</a></li>
                        <li><a href="{{url('admin/filter/attributes-filter')}}">Filters</a></li>
                    </ul>
                </li>
            </ul>
            <br><br>
            ...
            <form action="{{url('/admin/search/result')}}" method="get" autocomplete="off" style="position: absolute;">
                <div class="input-group">
                    <input id="search" name="search" type="text" class="form-control" placeholder="Search online...."
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2023 <a href="https://www.ampirmas.site" target="_blank">AMpirmas site</a>.</strong>
        All rights reserved.
    </footer>
